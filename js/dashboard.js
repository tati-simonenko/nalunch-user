            ...
            $('.chat-input').keypress(function (ev) {
                ...
                if (p == 13) {
                    if (chatText == "") {
                        ...
                        $('<li class="clearfix"><div class="chat-avatar"><img src="images/placeholder.png" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>Имя или логин</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
                    }
                    $(this).val('');
