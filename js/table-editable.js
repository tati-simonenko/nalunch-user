    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[6].innerHTML = '<a class="cancel" href="">Отменить</a>';
            }
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<a class="edit" href="">Редактировать</a>', nRow, 5, false);
            ...
            $('#editable-sample_new').click(function (e) {
                ...
                var aiNew = oTable.fnAddData(['', '', '', '',
                        '<a class="edit" href="">Редактировать</a>', '<a class="cancel" data-mode="new" href="">Cancel</a>'
                ]);
